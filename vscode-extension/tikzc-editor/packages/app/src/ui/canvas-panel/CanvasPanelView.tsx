...
type CanvasPanelViewProps = {
  ...
  onTextEditTextareaChange: (event: ReactSyntheticEvent<HTMLTextAreaElement>) => void;
  onTextEditTextareaCompositionEnd: (event: ReactSyntheticEvent<HTMLTextAreaElement>) => void;
...
export function CanvasPanelView(props: CanvasPanelViewProps) {
  const {
    ...
    onTextEditTextareaCompositionEnd,
            ...
            >
              ...
              <div className={css.textEditTextareaLayer}>
                <textarea
                  ...
                  onCompositionEnd={onTextEditTextareaCompositionEnd}
